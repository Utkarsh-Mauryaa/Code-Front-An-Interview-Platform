...
function InterviewScheduleUI() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="container max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        >
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button className="bg-amber-400 hover:bg-amber-300 text-black font-semibold rounded-xl px-5 h-10 transition-all duration-200 shadow-lg shadow-amber-400/20">
                <PlusIcon className="h-4 w-4 mr-2" />
                Schedule Interview
              </Button>
            </DialogTrigger>

            <DialogContent className="sm:max-w-[520px] max-h-[calc(100vh-80px)] overflow-auto bg-[#13131e] border-white/10 rounded-2xl text-white">
              <DialogHeader className="pb-2">
                <DialogTitle className="text-lg font-semibold text-white">Schedule New Interview</DialogTitle>
              </DialogHeader>
              ...
              <div className="space-y-5 py-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="bg-[#0a0a0f] border-white/10 text-white placeholder:text-slate-600 rounded-xl h-10 focus:border-amber-400/50 focus:ring-amber-400/20 transition-colors"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    className="bg-[#0a0a0f] border-white/10 text-white placeholder:text-slate-600 rounded-xl focus:border-amber-400/50 focus:ring-amber-400/20 transition-colors resize-none h-20"
                  />
                </div>
                  ...
                  <Select value={formData.candidateId} onValueChange={(candidateId) => setFormData({ ...formData, candidateId })}>
                    ...
                    <SelectContent className="bg-[#13131e] border-white/10 text-white rounded-xl">
                      {candidates.map((candidate) => (
                        <SelectItem key={candidate.clerkId} value={candidate.clerkId} className="hover:bg-white/5 rounded-lg">
                    ...
                    <Select onValueChange={addInterviewer}>
                      ...
                      <SelectContent className="bg-[#13131e] border-white/10 text-white rounded-xl">
                        {availableInterviewers.map((interviewer) => (
                          <SelectItem key={interviewer.clerkId} value={interviewer.clerkId} className="hover:bg-white/5 rounded-lg">
                            <UserInfo user={interviewer} />
                          </SelectItem>
                        ))}
                      </SelectContent>
                  ...
                  <div className="space-y-1.5 flex-1">
                    ...
                    <div className="rounded-xl border border-white/10 bg-[#0a0a0f] overflow-hidden">
                      <Calendar
                        ...
                        className="text-white [&_.rdp-day_button:hover]:bg-amber-400/20 [&_.rdp-day_button.rdp-day_selected]:bg-amber-400 [&_.rdp-day_button.rdp-day_selected]:text-black w-full"
                      />
                    </div>
                  </div>
                ...
                <div className="flex justify-end gap-3 pt-2">
                  ...
                  <Button
                    ...
                    disabled={isCreating}
                    className="bg-amber-400 hover:bg-amber-300 text-black font-semibold rounded-xl px-5 transition-all duration-200 shadow-lg shadow-amber-400/20"
                  >
                    {isCreating ? (
                      <>
        ...
        {!interviews ? (
          ...
          >
            <div className="p-4 rounded-2xl bg-[#13131e] border border-white/8">
              <CalendarDaysIcon className="size-8 text-slate-500" />
            </div>
